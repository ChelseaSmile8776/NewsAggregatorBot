...
public class ParserService {
    ...
    private boolean isAd(String text) {
        ...
        String[] adKeywords = {
                ...
                // 🆕 анонсы передач и объявления каналов:
                "слушайте", "каждый четверг", "каждую пятницу", "каждую среду",
                "каждый понедельник", "каждый вторник", "каждую субботу", "каждое воскресенье",
                "авторская программа", "выходит в эфир", "в эфире",
                "мы остаёмся", "мы остаемся", "мы находимся исключительно",
                "сторонние аккаунты", "наш канал не переезжает",
                "будьте внимательны", "доверяйте только",
                "не пропустите новое", "не пропустите выпуск",
                "обсуждаем ключевые тренды"
        };
